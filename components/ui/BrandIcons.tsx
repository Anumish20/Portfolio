 ...
 * -------------------------------------------------------------------------
 * Inline brand SVG icons (GitHub, LinkedIn).
 *
 * Recent versions of lucide-react removed brand glyphs, so we ship our own
 * minimal, accessible SVGs with the same `size`/`className` ergonomics as
 * lucide icons. Server-safe (no client JS).
 * -------------------------------------------------------------------------
 */
